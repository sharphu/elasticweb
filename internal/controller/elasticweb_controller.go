...
//+kubebuilder:rbac:groups=elasticweb.elasticweb.com,resources=elasticwebs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=elasticweb.elasticweb.com,resources=elasticwebs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=elasticweb.elasticweb.com,resources=elasticwebs/finalizers,verbs=update
